...
<body class="bg1">
    ...
    <div class="container">
        ...
        <!-- Outer Row -->
        <div class=" cardy row justify-content-center">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class=" bgcolor col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4  mb-4 textvert">Welcome Back!</h1>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small textvert" href="register.php">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
